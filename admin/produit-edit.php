...
if (!empty($_POST)) {
    ...
    // si une image a été téléchargée , $_FILES['photo']['tmp_name'] : original 
    if (!empty($_FILES['photo']['tmp_name'])) {
       ...
       // si le type n'est pas dans le tableau du dessus
...
<!--
L'attribut enctype est obligratoire pour un formulaire
qui contien un téléchargement de fichier
-->
